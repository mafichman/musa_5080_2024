...
This week, we are going to learn how to validate our models and understand our model errors. This will give us all the skills and code we need to put our midterm assignment together.
...
Bring in a wrangled data set - it has some new variables already created. Use the `glimpse` command to examine the data. The variable titles are fairly self-explanatory.
...
Here we can take a look at the first few rows of `reg.cv`
