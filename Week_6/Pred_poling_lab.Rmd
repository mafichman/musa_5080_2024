...
OK - now we get to the creation of the `secret sauce` of spatial predictive modeling - harnessing Local Moran's I - seeing whether cells are part of a significant cluster of high or low values. We will use the {spdep} package to build neighborhood weights and list to calculate local Moran's I.
