...
2.  Use {tidycensus} to gather ACS data for two different years
...
This lab is the "pantry" with all the ingredients for your second assignment, where you will adapt this analysis to analyze willingness to pay for transit in a separate city. Your job is to take this code base, and feed new census data and transit stops to it.

### Load packages and functions

There is a new wrinkle here - we use the `source` command to bring in customized functions from our text book.
